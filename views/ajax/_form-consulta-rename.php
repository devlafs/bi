...
$js = <<<JS
    ...
    $('#div-form-consulta-rename').on('beforeSubmit', 'form#form-consulta-rename', function () 
    {
        var form = $(this);
...
<div id="div-form-consulta-rename">
    
    <?php $form = ActiveForm::begin([
        'id' => 'form-consulta-rename',
        'enableClientValidation' => TRUE,
        'action' => '/ajax/rename-consulta?id=' . $model->id
    ]); ?>

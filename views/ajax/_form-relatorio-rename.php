...
$js = <<<JS
    ...
    $('#div-form-relatorio-rename').on('beforeSubmit', 'form#form-relatorio-rename', function () 
    {
        var form = $(this);
...
<div id="div-form-relatorio-rename">
    
    <?php $form = ActiveForm::begin([
        'id' => 'form-relatorio-rename',
        'enableClientValidation' => TRUE,
        'action' => '/ajax/rename-relatorio?id=' . $model->id
    ]); ?>

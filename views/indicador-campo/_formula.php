        ...
        <div class="card p-3">
            ...
            [
                ...
                [
                    ...
                    [
                        ...
                        'items' => ['formulavalor' => 'Valor', 'formulatexto' => 'Texto'],
                        'columnOptions' => ['colspan' => 2],
                    ],
                    'variavel_formula' =>
                    [
                        'label' => "Variável <i class='fa fa-question-circle' style='font-size: 10px;' title='Variável executada antes da utilização da fórmula - Exemplo: SET @idPedido = 10'></i>",
                        'type' => Form::INPUT_TEXT,
            ...
            [
                ...
                [
                    'campo' =>
                    [
                        'label' => "Fórmula <i class='fa fa-question-circle' style='font-size: 10px;' title='Utilize a referência do campo dentro de duas chaves - Exemplo: AVG({{23}})     |     {{34}} * {{12}}     |     CONCAT({{2}}, {{4}})'></i>",
                        'type' => Form::INPUT_TEXT,
                    ],
                ],
            ]); ?>

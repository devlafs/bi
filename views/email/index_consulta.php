...
[
    ...
    'value' => function ($model)
    {
        ...
        elseif($model->id_consulta && (!$model->consulta->indicador->is_ativo || $model->consulta->indicador->is_excluido))
        {
            $class = "badge badge-danger";
            $text = ($model->consulta->indicador->is_excluido) ? "Cubo Excluído" : "Cubo Inativo";
        }
        elseif($model->id_consulta && (!$model->consulta->is_ativo || $model->consulta->is_excluido))
        {
            $class = "badge badge-danger";
            $text = ($model->consulta->is_excluido) ? "Consulta Excluída" : "Consulta Inativa";
        }
...
<div class="email-index">
    ...
    <ul class="nav nav-tabs" id="email-tab" role="tablist">
        ...
        <li class="nav-item">
            ...
            <a class="nav-link active" id="consulta-tab" href="/email/index?t=consulta">Consulta</a>
        
        </li>
        
        <li class="nav-item">
        
            <a class="nav-link" id="consulta-tab" href="/email/index?t=painel">Painel</a>
        ...
        <div class="tab-pane fade show active" id="consulta" role="tabpanel" aria-labelledby="consulta-tab">
            ...
            <?php if($permissao->can('email', 'create')) : ?>
                ...
                <p class="text-right">
                    ...
                    <?= Html::a('<i class="fa fa-plus"></i> Novo (Consulta)', ['create', 't' => 'consulta'], ['class' => 'btn btn-primary']) ?>

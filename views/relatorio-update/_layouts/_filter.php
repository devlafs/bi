...
$js = <<<JS
    ...
    $(document).delegate(".select-choose-field", 'change', function(e) 
    {
        ...
        jQuery.ajax({
            url: '/relatorio-data/get-type-update?id=' + _id + '&and=' + _indexAnd + '&or=' + _indexOr,
    ...
    $(document).delegate("#add-atribute", 'click', function(e) 
    {
        ...
        jQuery.ajax({
            url: '/relatorio-data/and-filter-update?id={$model->id}&index=' + _next,
            success: function (_data) 
            {
    ...
    $(document).delegate(".save-filter", 'click', function(e) 
    {
        ...
        if(_currentTab == 'advanced-tab')
        {
            ...
            jQuery.ajax({
                url: '/relatorio-data/save-filter-update?id={$model->id}',
                data: {
    ...
    $(document).delegate(".save-conf-cons", 'click', function(e) 
    {
        ...
        jQuery.ajax({
            url: '/relatorio-data/save-config-relatorio?id={$model->id}',
...
$js_permissao = <<<JS
    ...
    { 
        ...
        jQuery.ajax({
            url: '/relatorio-data/permission-relatorio?relatorio_id={$model->id}&perfil_id=' + _perfil_id + '&permissao_id=' + _permissao_id + '&state=' + _value,
            type: 'GET'
        });
    }
...
<div class="sidebar--painel block__slide h-100 mh-100">
    ...
    <div class="sidebar--painelHeader d-flex justify-content-start pl-3 pr-3">
        ...
        <h5 class="modal-title mr-auto align-self-center text-uppercase">Configurações do Relatório</h5>
                ...
                <div class="bp--accordion" id="accordion" role="tablist" aria-multiselectable="true">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <label title="Limite de dados visualizados no relatório" class="mt-2">Limite de Dados</label>

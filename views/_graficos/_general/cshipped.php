...
$cParam = Yii::$app->request->get('c');
$uParam = Yii::$app->request->get('u');
$pParam = Yii::$app->request->get('p');
$bParam = Yii::$app->request->get('b');
$ajaxUrl = "'/consulta-embarcada/v?c={$cParam}&u={$uParam}&p={$pParam}&b={$bParam}'";

$view = (MobileMagic::isMobile()) ? 'mobile' : 'share';
